...
* xref:admin:components/meetings/agenda.adoc[Agenda]: for seeing the topics discussed in the meeting.
...
* https://lejourdapres.parlement-ouvert.fr/processes/ateliers/f/14/[Les ateliers]