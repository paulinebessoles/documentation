...
|Dropdown selector with all the meetings of this participatory space. The author of the proposal becomes the meeting.
...
When navigating in the proposals listing, you can filter the proposals by their origin.
...
* Groups: proposals created by participants that belong to a verified user group and choose that option when creating the proposal
