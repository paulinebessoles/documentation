...
For instance, if you have two debates, "Debate a" with weight "10" and "Debate b" with weight "0" then "Debate b" is first when ordering.
...
|Optional
|Check is you want to block new endorsements to be performed on debates at this phase. 
...
|Title
|Required
|The title of this debate. For instance, "How can we improve this process?"
...
This is shown publicly in the debate list.
