...
In the right panel, the authors can edit their proposals, and send them to the administrator validation step if the initiative is ready and has enough committee members.
...
Once all the conditions are right, the author can send the initiative to technical validation.
A modal is displayed to make sure the initiative is ready, as the author won't be able to edit it after this action. 
