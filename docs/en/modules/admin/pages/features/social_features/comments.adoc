...
how to enable comments on a component, please refer to the xref:features:components.adoc[Components] article. 
...
When clicking on a hashtag in a comment or another content, participant are redirected to the global search. 
