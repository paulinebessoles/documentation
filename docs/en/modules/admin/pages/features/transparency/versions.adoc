...
. Go to the content for which you want to check the different versions. 
. Click in the "see other versions" link in the bottom of the page. 
. From there you can change the visualisation of the version differences, and check all past versions.
